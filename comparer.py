...
class Comparer(Fixer):
    ...
    def compare(self):
        ...
        for used_table in self.used_tables:
            ...
            dubbed = used_numbers & self.all_numbers    # Пересечение использованных и новых
            self.all_origin = self.all_numbers - dubbed  # Всё без пересечений
            self.all_overlap.extend(dubbed)              # Помечаем как общий дубль.
